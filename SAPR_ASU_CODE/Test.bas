...
Public MaxNumber1 As Integer   'Максимальное значение нумерации существующих элементов. Это не общее число элементов, а макс цифра в обозначении.
Public MaxNumberFSA1 As Integer   'Максимальное значение нумерации существующих элементов. Это не общее число элементов, а макс цифра в обозначении.
...
Sub FindMAX1(vsoShapeOnPage As Visio.Shape)
...
Public Function ReNumber1(colShp As Collection, StartNumber As Integer) As Integer
'------------------------------------------------------------------------------------------------------------
...
Function WireX1(vsoShape As Visio.Shape) As Double
...
Function WireY1(vsoShape As Visio.Shape) As Double
...
Sub AutoNumFSA1(vsoShape As Visio.Shape)
'------------------------------------------------------------------------------------------------------------
...
'Ищем максимальное значение номера элемента
Sub FindMAXFSA1(vsoShapeOnPage As Visio.Shape)
...
Sub HideWireNumChildOnPage1()
    HideWireNumChild ActivePage
End Sub

Sub HideWireNumChildInDoc1()
    Dim vsoPage As Visio.Page
    Dim PageName As String
...
Public Sub HideWireNumChild1(vsoPage As Visio.Page)
'------------------------------------------------------------------------------------------------------------
...
'------------------------------------------------------------------------------------------------------------
Function ExtractOboz1(Oboz) ' Функция определения неизменяемой части обозначения

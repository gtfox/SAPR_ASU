'------------------------------------------------------------------------------------------------------------
' Module    : ExportSourceCode - экспорт кода VBA и исходника файла во внешние модули для коммита через ГитХаб
...
' Link      : www.graphicalfiresets.ru, vk.com/aigs_grafis, https://www.youtube.com/channel/UCWlqFPWAKnF61nRxrtk28dw
'------------------------------------------------------------------------------------------------------------

...
Public Const typeParent As Integer = 3 'Нумеруемый элемент схемы без катушки (Родительский) SA (Переключатель), SB (Кнопка), QF (Автомат 3ф), SF (Автомат 1ф), QSD (УЗО), QFD (Дифавтомат), QS (Выключатель нагрузки), QA (Автомат защиты двигателя), FU (Предохранитель), RU (Варистор)
